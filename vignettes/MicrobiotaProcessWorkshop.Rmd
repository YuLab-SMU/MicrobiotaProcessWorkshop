...
## 2. Importing the output of dada2
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=9.5, fig.height=8, fig.align="center",warning=FALSE, message=FALSE, fig.cap="\\label{fig:Rarecurve}Example of rarefaction curve of samples", rarecurve}
library(MicrobiotaProcess)
library(patchwork)
...
prare1 <- ggrarecurve(obj=rareres, factorNames="Group",
                      indexNames=c("Observe", "Chao1", "ACE")
                      ) +
...
### 3.2 Calculation and different analysis of alpha index
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=8, fig.height=3, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:Alphabox}Example of alpha box of samples", alphatest}
library(MicrobiotaProcess)
...
### 4.1 Statistics and visualization of specific levels
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=8.5, fig.height=4, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:Abundance1}Example of taxonomic abundance of samples", abundance}
library(ggplot2)
library(MicrobiotaProcess)
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=8.5, fig.height=4, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:Abundance2}Example of taxonomic abundance (Count) of samples", abundance2}
...
```{r, fold.output=FALSE, fold.plot=FALSE, fig.width=3, fig.height=3, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:PCA}Example of Venn plot", Venn}
...
```{r, old.output=FALSE, fold.plot=FALSE, fig.width=5, fig.height=3, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:PCA}Example of Upset plot", Upset}
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=9, fig.height=3.6, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:PCA}Example of PCA of samples", PCAplot}
library(MicrobiotaProcess)
library(patchwork)
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=9, fig.height=3.6, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:PCoA}Example of PCoA of samples", PCoAplot}
# distmethod
...
### 5.4 hierarchical cluster analysis of samples
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=10, fig.height=4, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:HClust}Example of hierarchical clustering of samples", Clust}
library(ggplot2)
library(MicrobiotaProcess)
library(ggtree)
...
### 6.1 visualization of different results by `ggdiffclade`
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=6, fig.height=6, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:clade}Example of different biomarker clade", plotclade}
...
### 6.2 visualization of different results by `ggdiffbox`
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=6, fig.height=4, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:diffboxplot}Example of biomarker boxplot and effect size", diffbox}
diffbox <- ggdiffbox(obj=deres, box_notch=FALSE, 
		     colorlist=c("#00AED7", "#FD9347"), l_xlabtext="relative abundance")
diffbox
```

### 6.3 visualization of different results by `ggdifftaxbar`
...
### 6.4 visualization of different results by `ggeffectsize`
...
```{r class.source = 'fold-show', fold.output=FALSE, fold.plot=FALSE, fig.width=5, fig.height=5, fig.align="center", warning=FALSE, message=FALSE, fig.cap="\\label{fig:ESplot}Example of effect size of biomarker", plotES}
